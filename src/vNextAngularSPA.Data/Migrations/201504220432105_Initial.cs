...
namespace vNextAngularSPA.Data.Migrations
{
    public partial class Initial : Migration
    {
        public override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable("BookmarkedPlace",
                c => new
                    {
                        Id = c.Int(nullable: false),
                        Address = c.String(),
                        Category = c.String(),
                        Rating = c.Decimal(nullable: false),
                        TS = c.DateTime(),
                        UserName = c.String(),
                        VenueID = c.String(),
                        VenueName = c.String()
                    })
                .PrimaryKey("PK_BookmarkedPlace", t => t.Id);
        ...
        public override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("BookmarkedPlace");
        }
    }
}