'use strict';
//app.controller('PlaceCtrl', function ($scope, placesExplorerService, placesPhotosService, placesDataService, $filter, $modal) {
app.controller('PlacesExplorerCtrl', function ($scope, placesExplorerService, placesPhotosService, $filter, $modal) {
