//app.factory('navigationSvc', ['$http', 'serviceHelperSvc', 'userProfileSvc', function ($http, serviceHelper, userProfileSvc) {
app.factory('navigationSvc', ['$http', 'userProfileSvc', function ($http, userProfileSvc) {
